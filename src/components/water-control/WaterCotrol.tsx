...
export const data = {
  labels: ["Water supplied", "Water left"],
  datasets: [
    {
      label: "# of Votes",
      data: [12, 19],
...
const options = {
    ...
    responsive: true,
    aspectRatio: 1, // Adjust this to control the aspect ratio of the chart
  };

type Props = {};

const WaterCotrol = (props: Props) => {
  return (
    <div className="border border-slate-200/70 rounded-xl p-4 bg-white flex flex-col">
      <p className="uppercase text-xl">Water control</p>
    ...
    //   options={options}
        ...
        data={data}
      />
      <div className="flex pt-20  flex-row items-center justify-between">
